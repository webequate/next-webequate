interface WebEquateLogoProps {
  className?: string;
}

const WebEquateLogo = ({
  className = "w-full md:w-3/5 lg:w-2/5 h-auto mx-auto pt-4 pb-2 sm:pb-2",
}: WebEquateLogoProps) => {
  return (
    <svg
      viewBox="0 0 512 90"
    ...
    >
      ...
      <rect
        ...
        width="64.057"
        height="16.088"
        style={{ paintOrder: "stroke", fill: "rgb(102, 153, 255)" }}
      />
      <rect
        x="188.019"
        y="47.97"
