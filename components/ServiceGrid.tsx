...
import * as Icons from "react-icons/fa"; // Dynamically import all Font Awesome icons
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6">
      {services.map((service) => {
        const Icon = Icons[service.icon as keyof typeof Icons]; // Dynamically resolve the icon
