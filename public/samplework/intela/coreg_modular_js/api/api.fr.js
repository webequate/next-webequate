...
var coregApi = {
  validatePhone: function () {
    ...
    // Validate phone
    var url_phone =
      "/api/v1/isvalidphone/fr/" +
      $("#phone").val() +
      "/ws/?apikey=intela-9a0843d7-da06-466e-b908-36ae8eb5bdf3";
  ...
  validateEmail: function () {
    ...
    var url_email =
      ...
      $("#lastName").val() +
      "/ws/" +
      "?apikey=intela-9a0843d7-da06-466e-b908-36ae8eb5bdf3";
  ...
  validateZip: function () {
    ...
    $.getJSON(url_zip, function (result) {
      ...
      if (result.data != "false" && result.data.towns.length > 0) {
        ...
        $("#addressList").append(
          "<li><a href=\"javascript:void(0);\" onclick=\"$.fancybox.close(); coregUtility.addSubmitClickHandler(); $('#zip').attr('disabled','');\">" +
            $.i18n.prop("add.town") +
            "</a></li>"
        );
  ...
  createLead: function () {
    var url =
      "/api/v1/createlead/?apikey=intela-9a0843d7-da06-466e-b908-36ae8eb5bdf3";
